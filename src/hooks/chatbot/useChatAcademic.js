...
import { useChatAcademicApi } from '../../contexts/chatbot/ChatAcademicApi';
import { useRecentChatsApi } from '../../contexts/chatbot/ChatRecentApi';
import { v4 as uuidv4 } from 'uuid';

export const useChatAcademic = (initialSelectedChat, categoryNo) => {
    ...
    const academicApi = useChatAcademicApi();
    ...
    const sendMessage = useCallback(async (messageText) => {
        if (messageText.trim()) {
            ...
            try {
                ...
                const response = await academicApi.AcademicChatBotData(requestData);
    ...
    }, [academicApi, categoryNo, userData, generateNewSessionId]);
